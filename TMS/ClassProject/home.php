...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
   ...
   elseif ($select == "Graduation"){
	...
	elseif ($select=="Experience"){
		$query="Select * from tbl_student where Experience LIKE '%$searchtxt%' Or Experience > 1 ";
	}
			  ...
			  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="interested_teachers.php?id=<?php echo urlencode ($id) ; ?>">Interested Teachers</a></li>
                         <li class="divider"></li>
                        <li><a href="signup.php?id=<?php echo urlencode ($id) ; ?>" style="">Send Mail</a></li>
                    </ul>
                </li>
   ...
   <div class="container">
	  <form  class="form-group"  method="POST">
	    <div class="input-group">
         ...
         <input type="text"  class="form-control search " id="search" placeholder="Search By " name="search_text">
       </div>
