...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if($select == "Location " ){
$query="Select * from tbl_student where Location  LIKE '%$searchtxt%' and Qualification = 'Student' and State='Unmanaged' ";
	}
	
   elseif ($select == "Graduation"){
$query="Select * from tbl_student where Graduation  LIKE '%$searchtxt%' and Qualification = 'Student' and State='Unmanaged' ";
	}
	
	
	
	elseif($select == "Demand" ){
$query="Select * from tbl_student where Demand  LIKE '%$searchtxt%' and Qualification = 'Student' and State='Unmanaged' ";
	}
	
	elseif ($select=="Department"){
$query="Select * from tbl_student where Department  LIKE '%$searchtxt%' and Qualification = 'Student' and State='Unmanaged' ";
	}
	elseif ($select==" " && $searchtxt==" "){
		$query="Select * from tbl_student where Qualification = 'Student' And State ='Unmanaged' ";
	}
	else{
	$query="Select * from tbl_student where Qualification = 'Student' And State ='Unmanaged'";
 }
